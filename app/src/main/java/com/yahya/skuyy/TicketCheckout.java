...
public class TicketCheckout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvDateResult = (TextView) findViewById(R.id.date_wisata);
...
//                reference.getRef().child("date_wisata").setValue(date_wisata.getText().toString());
            ...
            public void onClick(View v) {
                ...
                reference3.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        reference3.getRef().child("date_wisata").setValue(tvDateResult.getText().toString());
                        reference3.getRef().child("time_wisata").setValue(time_wisata);
//                        xdate_wisata = (date_wisata.getText().toString());

                        Intent gotosuccess = new Intent(TicketCheckout.this, SuccessBuyTicketAct.class);
                ...
                reference.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        reference.getRef().child("date_wisata").setValue(tvDateResult.getText().toString());
                    }
                    @Override
                    public void onCancelled(@NonNull DatabaseError databaseError) {
